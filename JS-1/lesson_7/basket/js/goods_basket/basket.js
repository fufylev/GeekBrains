...
class Basket {
    ...
    render() {
        ...
        for ( let i = 0; i < this.basketItems.length; i++ ) {
            let $block1 = $( `
                <div class="cart-product" data-id="${ this.basketItems[ i ].id_product }">
                    ...
                    <div class="cart-product__content">
                        ...
                        <p class="cart-product__price">${ this.basketItems[ i ].price }&nbsp;&nbsp;&nbsp;X&nbsp;&nbsp;${ this.basketItems[ i ].product_amount }&nbsp;&nbsp;Total&nbsp;&nbsp;${ this.basketItems[ i ].totalSum }$</p>
                    </div>
                    <div class="cart-product__delete" data-id="${ this.basketItems[ i ].id_product }"><i class="fas fa-times-circle"></i></div>
                </div>` );
        ...
        let $block2 = $( `
                ...
                <span class="cart-product__total-price">${ this.countGoods }&nbsp;&nbsp;|&nbsp;&nbsp;$${ this.totalPrice }.00</span>
                </p>
                <a href="check_out.html" class="cart-product__button cart-product__button_pink">Checkout</a>
                <a href="shoping_cart_list.html" class="cart-product__button cart-product__button_black">Go to cart</a>
        ` );
