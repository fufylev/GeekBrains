...
class Twig_Node_Module extends Twig_Node
{
        ...
        if ($countTraits) {
            ...
            foreach ($this->getNode('traits') as $i => $trait) {
                ...
                $compiler
                    ...
                    ->raw(".'\" cannot be used as a traits.');\n")
                    ->outdent()
                    ->write("}\n")
    ...
    {
        // A template can be used as a traits if:
        //   * it has no parent
        //   * it has no macros
        //   * it has no body
        //
        // Put another way, a template can be used as a traits if it
